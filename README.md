...
- [1. LLM-Extended Relational Queries](#1-llm-extended-relational-queries)
- [2. Semantic Operators & Declarative AI Analytics](#2-semantic-operators--declarative-ai-analytics)
- [3. String Similarity Search and Join](#3-string-similarity-search-and-join)

---

## 1. LLM-Extended Relational Queries
...
## 2. Semantic Operators & Declarative AI Analytics
...
## 3. String Similarity Search and Join

**String Similarity Search and Join: A Survey.** ![](https://img.shields.io/badge/-survey-lightgrey) ![](https://img.shields.io/badge/-string_similarity-orange) ![](https://img.shields.io/badge/-data_cleaning-yellowgreen)

*Minghe Yu, Guoliang Li, Dong Deng, Jianhua Feng. Tsinghua University. Frontiers of Computer Science, 2016.* [[paper](https://link.springer.com/article/10.1007/s11704-015-5900-5)]
